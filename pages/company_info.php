<section id="company-info" class="sec">
  ...
  <div class="card" style="background: linear-gradient(135deg, rgba(229,9,20,0.05), rgba(0,0,0,0.2)); border-color: rgba(229,9,20,0.2);">
    <div class="chdr" style="border-bottom-color: rgba(255,255,255,0.05);"><span class="ctitle"><i class="fas fa-info-circle" style="color:var(--red);margin-left:7px"></i><?= $t["contact_support"] ?? "معلومات التواصل وطلب الدعم الفني" ?></span></div>
    <div class="cbody" style="display:flex; flex-wrap:wrap; gap: 20px; align-items:center; justify-content: space-between;">
      <div style="flex:1; min-width:260px;">
        <h3 style="color:var(--t1); margin-bottom:5px; font-size:1.4rem; font-weight:900;">SHASHITY PRO <span style="font-size:0.75rem; background:rgba(229,9,20,0.2); padding:2px 8px; border-radius:20px; vertical-align:middle; font-weight:normal;"><?= $t["official_version"] ?? "الإصدار الرسمي" ?></span></h3>
        <p style="color:var(--t3); margin-bottom:15px; font-size:0.85rem;"><?= $t["company_desc"] ?? "نظام إدارة منصات البث المباشر المتقدم المستوحى من تقنيات البث الحديثة." ?></p>
        <div style="display:flex; flex-direction:column; gap:10px;">
          <div style="display:flex; align-items:center; gap:12px; font-size:0.95rem;">
            ...
            <span><?= $t["company_location"] ?? "العراق - موصل" ?></span>
          </div>
          <div style="display:flex; align-items:center; gap:12px; font-size:0.95rem;">
